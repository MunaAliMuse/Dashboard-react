...
function Sidenav({children}){
    ...
    return <div>
    <div style={{width:  isOpen  === true ?   "100px" : "" }} className="bg-green-900 fixed overflow-hidden transition-all duration-500 text-white h-screen w-[22%]
     border-r-4 border-red-900">
         ...
         <div style={{display: isOpen === true ? "none" : "flex"}} className="ml-12 mt-10 text-2xl flex flex-col gap-12 transition-all duration-500">
              ...
              <NavLink to={"/Services"} className="cursor-pointer hover:underline"><i class="fa-solid fa-bag-shopping"></i> Services</NavLink>
     ...
     <div style={{marginLeft: isOpen=== true ? "100px": "" }} className="ml-[25%] transition-all duration-500">
        {children}
